...
func TestSensor_GenerateValue(t *testing.T) {
	testSensor := DefaultSensor{ID: 1, Type: "test", Name: "Тестовый датчик", MinValue: 25, MaxValue: 30, Value: 25}
...
func TestSensor_String(t *testing.T) {
	...
	testSensor := DefaultSensor{ID: 1, Type: "test", Name: "Тестовый датчик", MinValue: 25, MaxValue: 30, Value: 25, TimeStamp: time.Date(2021, time.June, 23, 10, 30, 0, 0, loc)}
